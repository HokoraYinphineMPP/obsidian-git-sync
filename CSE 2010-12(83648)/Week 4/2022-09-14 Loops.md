...
10| }
```
1) Lets call the yellow loop, Loop 1. And the blue loop, Loop 2. Notice that Loop 2 is inside of Loop 1. 
...
6) At the end of Loop 2, the j+=2 update statement is executed. 1.:12,::::ntitn is checked again, if it is true, we go back to step 5. Repeat until Loop 2's 
- Once Loop 2's condition is false,. second coot statement of Loop 1 is executed and Lon,. ount is increment. lay I.. . At the end of Loop I., the statement Is executed. , Loop n condition is checked again. If it is true, we go hack to step I . Repeat steps 3-10 until Loop condition is false. 
