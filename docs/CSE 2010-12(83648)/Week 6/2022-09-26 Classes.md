...
##### For example, the word circle is a type. We can have different instances of

##### circles, some with different radii.


### Background: Attributes and Behaviors

##### ● Any instance of a type that we encounter has a set of attributes and a set
...
○ For example, if an instance is an employee, we assume they can give their name, give

their address, give their position, etc.
